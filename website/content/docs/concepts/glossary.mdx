...
| **Recipe** | A shareable list of package references with optional tags and notes, independent of an instance. |
| **Collection** | An in-place package group in one instance, identified only by its name. See [Collections](/docs/managing/collections). |
