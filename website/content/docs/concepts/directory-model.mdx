...
If a program replaces a projected Local Data link with a regular file in `build/`, two copies can conflict on the next deploy. See [Known Issues: Local Data copies](/docs/appendix/known-issues) before treating a snapshot as a backup of both.
