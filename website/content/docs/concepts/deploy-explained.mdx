...
Files from your `import/` and `persist/` directories are also layered into `build/` in priority order. See [Directory Model →](/docs/concepts/directory-model) for how that works.
