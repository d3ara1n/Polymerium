...
| **File organization** | import / persist / build + virtual working copy | Single `.minecraft` folder |
...
└── build/     ← Final game directory; holds import working copy
```
...
| Directory model (import/persist/build) | ✅ | ❌ |
