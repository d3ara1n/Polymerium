...
| **File organization** | Pack Source (`import/`) / Local Data (`persist/`) / Run Directory (`build/`) | Single `.minecraft` folder |
| **Reset/rebuild** | Clear the Run Directory, then redeploy from metadata | Manual file deletion/reimport |
...
| Feature | Polymerium | Prism Launcher |
|---------|:----------:|:--------------:|
| **Snapshots** | ✅ Save/restore/diff managed instance state | ❌ |
