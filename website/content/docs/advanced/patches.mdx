...
If you maintain older format 1 patches with a single `javaMajor`, see [Compatibility and migration](/docs/appendix/compatibility) before editing or archiving them.
