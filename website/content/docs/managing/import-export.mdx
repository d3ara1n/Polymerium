...
If you're coming from Prism Launcher, MultiMC, or the CurseForge app, you can import your existing modpacks directly. See the migration guides:

- [Migrate from Prism / MultiMC →](/docs/guides/migrate-from-prism)
- [Migrate from Shard →](/docs/guides/migrate-from-shard)
