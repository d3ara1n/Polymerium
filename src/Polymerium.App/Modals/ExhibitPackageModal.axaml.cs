...
public partial class ExhibitPackageModal : Modal
{
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == SelectedVersionProperty) LazyChangelog = ConstructChangelog();

        if (change.Property == IsDetailPanelVisibleProperty) isDetailPanelVisible = change.GetNewValue<bool>();
    }
    ...
    private void Apply()
    {
        if (Exhibit.State is null) Exhibit.State = ExhibitState.Adding;
