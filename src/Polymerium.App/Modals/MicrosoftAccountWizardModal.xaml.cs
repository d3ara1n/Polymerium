...
public sealed partial class MicrosoftAccountWizardModal
{
    ...
    private void OpenButton_Click(object sender, RoutedEventArgs e) => UriFileHelper.OpenInExternal(verificationUrl);

    private void ModalBase_Unloaded(object sender, RoutedEventArgs e) => source.Cancel();
