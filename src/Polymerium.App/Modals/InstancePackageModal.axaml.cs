...
public partial class InstancePackageModal : Modal
{
    ...
    private LazyObject ConstructVersions()
    {
        var lazy = new LazyObject(async t =>
            ...
            _ =>
            {
                if (Model.Version is InstancePackageVersionModel v) SelectedVersionProxy = v;
            });
    ...
    {
        if (Model.Version is InstancePackageVersionModel v) v.IsCurrent = true;
    }
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == IsFilterEnabledProperty) LazyVersions = ConstructVersions();
    ...
    private void RemoveTag(string? tag)
    {
        ...
        if (index >= 0) Model.Tags.RemoveAt(index);
    }
