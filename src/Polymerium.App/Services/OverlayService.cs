...
public class OverlayService
{
        ...
        string? watermark = null)
    {
        ...
        if (await PopDialogAsync(dialog) && dialog.Result is string input) return input;
    ...
    public async Task<string?> RequestFileAsync(string? message = null, string? title = null)
    {
        ...
        if (await PopDialogAsync(dialog) && dialog.Result is string path && File.Exists(path)) return path;
