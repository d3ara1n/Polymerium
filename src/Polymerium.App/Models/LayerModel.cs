...
public record LayerModel
{
    private CancellationTokenSource
        tokenSource = CancellationTokenSource.CreateLinkedTokenSource(App.Current.Token);
    ...
    private bool CanRemoveLoader(LoaderModel? loader) => loader != null && !IsLocked.Value;
