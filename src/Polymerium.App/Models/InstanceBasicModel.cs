...
public partial class InstanceBasicModel : ModelBase
{
    ...
    [ObservableProperty] public partial string LoaderLabel { get; set; } = Resources.Enum_Vanilla;

    [ObservableProperty] public partial string SourceLabel { get; set; } = "local";
    ...
    {
        if (!string.IsNullOrEmpty(value) && PackageHelper.TryParse(value, out var result)) SourceLabel = result.Label;
    }

    [ObservableProperty] public partial string? Loader { get; set; }
