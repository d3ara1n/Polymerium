...
public partial class App
{
    ...
    private void App_UnhandledException(object sender, UnhandledExceptionEventArgs e) => Dump(e.Exception);

    private void CurrentDomain_UnhandledException(object sender, System.UnhandledExceptionEventArgs e) =>
        Dump(e.ExceptionObject);

    private void Dump(object core)
    {
        var path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".trident",
            ".polymerium", "dump", $"{DateTimeOffset.Now.ToFileTime()}.txt");
