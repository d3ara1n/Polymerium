...
public partial class MarketplaceSearchViewModel : ViewModelBase
{
    ...
    [ObservableProperty] public partial int LayoutIndex { get; set; }
    ...
    [ObservableProperty] public partial string? FilteredVersion { get; set; }

    [ObservableProperty] public partial LoaderBasicModel? FilteredLoader { get; set; }

    [ObservableProperty] public partial InfiniteCollection<ExhibitModel>? Exhibits { get; set; }

    [ObservableProperty] public partial Bitmap? HeaderImage { get; set; }
    ...
    {
        if (exhibit is not null) TopLevel.GetTopLevel(MainWindow.Instance)?.Launcher.LaunchUriAsync(exhibit.Reference);
    }
