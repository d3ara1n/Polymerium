    ...
    NotificationService notificationService) : ViewModelBase
{
    ...
    {
        if (!Directory.Exists(path)) return (0ul, 0ul);
    ...
    [ObservableProperty] public partial IReadOnlyList<ISeries> TotalSeries { get; set; }

    [ObservableProperty] public partial ulong TotalSize { get; set; }

    [ObservableProperty] public partial ulong CacheSize { get; set; }

    [ObservableProperty] public partial ulong InstanceSize { get; set; }

    [ObservableProperty] public partial ulong PackageSize { get; set; }

    [ObservableProperty] public partial ulong PackageCount { get; set; }

    [ObservableProperty] public partial ulong LibrarySize { get; set; }

    [ObservableProperty] public partial ulong AssetSize { get; set; }

    [ObservableProperty] public partial ulong RuntimeSize { get; set; }
