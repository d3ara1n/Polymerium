...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    {
        if (view != null) _navigationService.Navigate(view);
    }
    ...
    private async Task ApplyUpdateAsync(AppUpdateModel? model)
    {
        ...
        try
        {
            ...
            {
                Dispatcher.UIThread.Post(() => progress.Report(value));
            }
    ...
    {
        if (model != null) _updateManager.ApplyUpdatesAndRestart(model.Update);
    }
    ...
    [ObservableProperty] public partial AppUpdateModel? UpdateTarget { get; set; }

    #endregion

    #region SuperPowerActivated

    [ObservableProperty] public partial bool SuperPowerActivated { get; set; }
    ...
    [ObservableProperty] public partial bool TitleBarVisibility { get; set; }
    ...
    [ObservableProperty] public partial int SidebarPlacement { get; set; }
    ...
    [ObservableProperty] public partial AccentColor AccentColor { get; set; }
    ...
    [ObservableProperty] public partial CornerStyle CornerStyle { get; set; }
    ...
    [ObservableProperty] public partial int BackgroundMode { get; set; }
    ...
    [ObservableProperty] public partial int DarkMode { get; set; }
    ...
    [ObservableProperty] public partial LanguageModel Language { get; set; }
    ...
    [ObservableProperty] public partial uint JavaMaxMemory { get; set; }
    ...
    [ObservableProperty] public partial string JavaAdditionalArguments { get; set; }
    ...
    [ObservableProperty] public partial uint WindowInitialWidth { get; set; }
    ...
    [ObservableProperty] public partial uint WindowInitialHeight { get; set; }
