...
{
    public static void ParseNodeToInline(InlineCollection collection, HtmlNode node, string reference,
        bool ignoreText = false)
    {
        switch (node.NodeType)
        {
            ...
            case HtmlNodeType.Document:
                foreach (var child in node.ChildNodes) ParseNodeToInline(collection, child, reference);
                break;
