...
public class PageSlideTransition(DirectionFrom direction = DirectionFrom.Right) : PageTransitionBase
{
    protected override void Configure(Builder from, Builder to, Lazy<Visual> parentAccessor)
    {
        ...
        from
           ...
           .AddFrame(0d, [(translateProperty, 0), (Visual.OpacityProperty, 1d)])
