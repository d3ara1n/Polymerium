...
public static class LocalizedEnumConverters
{
    public static IValueConverter LocalizedPackageBulkUpdatePreviewerTagPolicy { get; } =
        new RelayConverter((v, _) => v switch
        {
    ...
    public static IValueConverter LocalizedResourceKind { get; } = new RelayConverter((v, _) =>
    {
    ...
    public static IValueConverter LocalizedReleaseType { get; } = new RelayConverter((v, _) =>
    {
    ...
    public static IValueConverter LocalizedLaunchMode { get; } = new RelayConverter((v, _) =>
    {
    ...
    public static IValueConverter LocalizedSelectorType { get; } = new RelayConverter((v, _) =>
    {
        if (v is Profile.Rice.Rule.RuleSelector.SelectorType type)
        {
            return type switch
            {
                ...
                Profile.Rice.Rule.RuleSelector.SelectorType.Pref => Resources.SelectorType_Pref,
