...
public partial class PackageSelectorDialog : Dialog
{
    ...
    public static readonly DirectProperty<PackageSelectorDialog, ReadOnlyObservableCollection<SelectablePackageModel>?>
        ViewProperty =
            AvaloniaProperty
               .RegisterDirect<PackageSelectorDialog, ReadOnlyObservableCollection<SelectablePackageModel>
                    ?>(nameof(View), o => o.View, (o, v) => o.View = v);

    public static readonly DirectProperty<PackageSelectorDialog, string> FilterTextProperty =
        AvaloniaProperty.RegisterDirect<PackageSelectorDialog, string>(nameof(FilterText),
                                                                       o => o.FilterText,
                                                                       (o, v) => o.FilterText = v);
    ...
    public static readonly DirectProperty<PackageSelectorDialog, IReadOnlyList<string>> AuthorsProperty =
        AvaloniaProperty.RegisterDirect<PackageSelectorDialog, IReadOnlyList<string>>(nameof(Authors),
            o => o.Authors,
            (o, v) => o.Authors = v);

    public static readonly DirectProperty<PackageSelectorDialog, IReadOnlyList<string>> TagsProperty =
        AvaloniaProperty.RegisterDirect<PackageSelectorDialog, IReadOnlyList<string>>(nameof(Tags),
            o => o.Tags,
            (o, v) => o.Tags = v);
