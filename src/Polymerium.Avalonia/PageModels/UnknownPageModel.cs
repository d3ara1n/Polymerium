    ...
    ConfigurationService configurationService) : ViewModelBase
{
    ...
    private void ShowInformation() =>
        notificationService
           .PopMessage("Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~Hello Hi~",
                       "Hi there!");
    ...
    private void ShowDanger() =>
        notificationService.PopProgress("Hello",
                                        "Hi there!",
                                        GrowlLevel.Danger,
    ...
    {
        var dialog = overlayService.CreateDialog<ModpackImporterDialog>();
        if (await overlayService.PopDialogAsync(dialog) && dialog.Result is ModpackImporterResult result)
        {
            notificationService.PopMessage(result.ToString(), result.GetType().Name);
        }
    }
