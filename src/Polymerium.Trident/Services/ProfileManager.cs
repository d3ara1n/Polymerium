...
public class ProfileManager : IDisposable
{
        ...
        IDictionary<string, object> overrides)
    {
        ...
        foreach (var remove in removeSet) handle.Value.Setup.Packages.Remove(remove);

        foreach (var add in changeSet.Values) handle.Value.Setup.Packages.Add(new(add, true, source, null));
