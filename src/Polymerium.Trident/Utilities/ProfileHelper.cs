...
{
    public static string? PickIcon(string key) => FileHelper.PickExists(PathDef.Default.DirectoryOfHome(key), ["icon.png", "icon.jpeg", "icon.jpg", "icon.webp", "icon.bmp", "icon.gif"]);
