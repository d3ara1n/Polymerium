...
public class TransientData
{
    ...
    public void AddFragile(FragileFile fragile) => FragileFiles.Add(fragile);

    public void AddPersistent(PersistentFile persistent) => PersistentFiles.Add(persistent);

    public void AddPresent(PresentFile present) => PresentFiles.Add(present);

    public void AddExplosive(ExplosiveFile explosive) => ExplosiveFiles.Add(explosive);
