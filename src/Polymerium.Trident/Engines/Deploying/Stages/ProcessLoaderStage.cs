...
public class ProcessLoaderStage(IHttpClientFactory factory) : StageBase
{
    ...
    private string ConditionOfComponent(string component) => $"component:{component}";
    ...
    private async Task InstallFabricAsync(ArtifactBuilder builder, string uid, string version)
    {
        ...
        var intermediary = await PrismLauncherHelper.GetVersionAsync(PrismLauncherHelper.UID_INTERMEDIARY,
            Context.Metadata.Version, factory, Context.Token);
